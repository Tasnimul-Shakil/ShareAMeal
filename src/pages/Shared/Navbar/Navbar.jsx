...
import mainLogo from "../../../assets/ShareMeal.svg";
...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      ...
      <li>
        <NavLink to="/ViewAllCards">Available Foods</NavLink>
      </li>
      <li>
  ...
  return (
    <div className="navbar ">
      <div className="navbar-start">
        ...
        <a
          href="/"
          className="btn border-none bg-transparent  hover:bg-[#2b3440] text-xl text-[#e22a35] hover:text-[#ffffff]"
        >
          <img className="h-10 w-auto" src={mainLogo} alt="" />
          ShareAMeal
        </a>
      </div>
